...
class DD_DataCollatorWithPadding(DataCollatorWithPadding):
...
class DDDataset(Dataset):
    def __init__(self, tokenizer, filename, usedata, bucket_num = 12):
        # bucket_num  是默认的分桶数量
